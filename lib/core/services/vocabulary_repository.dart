...
class VocabularyRepository {
  ...
  late Box<WordRecord> _box;
  late Box _customBox;

  Future<void> init() async {
    await Hive.initFlutter();
    Hive.registerAdapter(WordRecordAdapter()); // Az önce ürettiğimiz adaptör
    _box = await Hive.openBox<WordRecord>(_boxName);
